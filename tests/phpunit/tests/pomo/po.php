...
class Tests_POMO_PO extends WP_UnitTestCase {
	 ...
	 * @var string
	 */
	const MAIL_TEXT = 'Your new ClassicPress blog has been successfully set up at:
...
msgstr[2] "бабаяга"',
	...
	public function test_import_from_file() {
		...
		$multiple_line_entry = new Translation_Entry(
			array(
				'singular'     => 'The first thing you need to do is tell Blogger to let ClassicPress access your account. You will be sent back here after providing authorization.',
