...
class Tests_DB extends WP_UnitTestCase {
	...
	/**
 * The wpdb->use_mysqli property is no longer used in core, but needs to be retained
 * for backward compatibility reasons and can be accessed externally due to the
 * `__get()` magic method.
 *
 * @since 3.9.0
 * @ticket 59118
