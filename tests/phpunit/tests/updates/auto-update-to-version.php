...
class Tests_Auto_Update_To_Version extends WP_UnitTestCase {
	...
	public function test_auto_update_same() {
		$this->assertFalse( Core_Upgrader::_auto_update_enabled_for_versions(
			'1.0.0', '1.0.0', true
		) );
		...
		$this->assertFalse( Core_Upgrader::_auto_update_enabled_for_versions(
			'1.0.0-beta2+migration.20181220', '1.0.0-beta2+migration.20181221', true
		) );

		$this->assertFalse( Core_Upgrader::_auto_update_enabled_for_versions(
			'1.0.0-beta2+migration.20181220', '1.0.0-beta2', true
		) );
	}

	public function test_auto_update_basic() {
		$this->assertTrue( Core_Upgrader::_auto_update_enabled_for_versions(
			'1.0.0', '1.0.1', true
		) );
