(function () {
	...
	function requireQuery () {
		...
		hasRequiredQuery = 1;
		query = function() { // ClassicPress: defer loading via require()
	...
	var postImage;
	var hasRequiredPostImage;

	function requirePostImage () {
		if (hasRequiredPostImage) return postImage;
		hasRequiredPostImage = 1;
		postImage = function() { // ClassicPress: defer loading via require()
	...
	var hasRequiredModels_manifest;

	function requireModels_manifest () {
		if (hasRequiredModels_manifest) return models_manifest;
		hasRequiredModels_manifest = 1;
		var $ = jQuery,
		...
		Attachment = media.model.Attachment = requireAttachment()();
		Attachments = media.model.Attachments = requireAttachments()();

		media.model.Query = requireQuery()();
		media.model.PostImage = requirePostImage()();
		media.model.Selection = requireSelection()();
		...
		_.extend( media, /** @lends wp.media */{
			 ...
			 *
			 * Sends a POST request to ClassicPress.
			 ...
			 *
			 * Sends an XHR request to ClassicPress.
