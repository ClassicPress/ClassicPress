(function () {
	...
	function requireRegion () {
		if (hasRequiredRegion) return region;
		hasRequiredRegion = 1;
	...
	function requireState () {
		...
		hasRequiredState = 1;
		state = function() { // ClassicPress: defer loading via require()
	...
	var selectionSync;
	var hasRequiredSelectionSync;

	function requireSelectionSync () {
		if (hasRequiredSelectionSync) return selectionSync;
		hasRequiredSelectionSync = 1;
		selectionSync = function() { // ClassicPress: defer loading via require()
	...
	var library$1;
	var hasRequiredLibrary$1;

	function requireLibrary$1 () {
		if (hasRequiredLibrary$1) return library$1;
		hasRequiredLibrary$1 = 1;
		library$1 = function() { // ClassicPress: defer loading via require()
	...
	var imageDetails$2;
	var hasRequiredImageDetails$2;

	function requireImageDetails$2 () {
		if (hasRequiredImageDetails$2) return imageDetails$2;
		hasRequiredImageDetails$2 = 1;
		imageDetails$2 = function() { // ClassicPress: defer loading via require()
		...
		return imageDetails$2;
	}

	var galleryEdit;
	var hasRequiredGalleryEdit;

	function requireGalleryEdit () {
		if (hasRequiredGalleryEdit) return galleryEdit;
		hasRequiredGalleryEdit = 1;
		galleryEdit = function() { // ClassicPress: defer loading via require()
	...
	var galleryAdd;
	var hasRequiredGalleryAdd;

	function requireGalleryAdd () {
		if (hasRequiredGalleryAdd) return galleryAdd;
		hasRequiredGalleryAdd = 1;
		galleryAdd = function() { // ClassicPress: defer loading via require()
	...
	var collectionEdit;
	var hasRequiredCollectionEdit;

	function requireCollectionEdit () {
		if (hasRequiredCollectionEdit) return collectionEdit;
		hasRequiredCollectionEdit = 1;
		collectionEdit = function() { // ClassicPress: defer loading via require()
	...
	var collectionAdd;
	var hasRequiredCollectionAdd;

	function requireCollectionAdd () {
		if (hasRequiredCollectionAdd) return collectionAdd;
		hasRequiredCollectionAdd = 1;
		collectionAdd = function() { // ClassicPress: defer loading via require()
	...
	var featuredImage;
	var hasRequiredFeaturedImage;

	function requireFeaturedImage () {
		if (hasRequiredFeaturedImage) return featuredImage;
		hasRequiredFeaturedImage = 1;
		featuredImage = function() { // ClassicPress: defer loading via require()
	...
	var replaceImage;
	var hasRequiredReplaceImage;

	function requireReplaceImage () {
		if (hasRequiredReplaceImage) return replaceImage;
		hasRequiredReplaceImage = 1;
		replaceImage = function() { // ClassicPress: defer loading via require()
	...
	var editImage$1;
	var hasRequiredEditImage$1;

	function requireEditImage$1 () {
		if (hasRequiredEditImage$1) return editImage$1;
		hasRequiredEditImage$1 = 1;
		editImage$1 = function() { // ClassicPress: defer loading via require()
	...
	var mediaLibrary;
	var hasRequiredMediaLibrary;

	function requireMediaLibrary () {
		if (hasRequiredMediaLibrary) return mediaLibrary;
		hasRequiredMediaLibrary = 1;
		mediaLibrary = function() { // ClassicPress: defer loading via require()
	...
	var embed$2;
	var hasRequiredEmbed$2;

	function requireEmbed$2 () {
		if (hasRequiredEmbed$2) return embed$2;
		hasRequiredEmbed$2 = 1;
		embed$2 = function() { // ClassicPress: defer loading via require()
	...
	var cropper$1;
	var hasRequiredCropper$1;

	function requireCropper$1 () {
		if (hasRequiredCropper$1) return cropper$1;
		hasRequiredCropper$1 = 1;
		cropper$1 = function() { // ClassicPress: defer loading via require()
	...
	var customizeImageCropper;
	var hasRequiredCustomizeImageCropper;

	function requireCustomizeImageCropper () {
		if (hasRequiredCustomizeImageCropper) return customizeImageCropper;
		hasRequiredCustomizeImageCropper = 1;
		customizeImageCropper = function() { // ClassicPress: defer loading via require()
	...
	var siteIconCropper$1;
	var hasRequiredSiteIconCropper$1;

	function requireSiteIconCropper$1 () {
		if (hasRequiredSiteIconCropper$1) return siteIconCropper$1;
		hasRequiredSiteIconCropper$1 = 1;
		siteIconCropper$1 = function() { // ClassicPress: defer loading via require()
	...
	function requireView () {
		...
		hasRequiredView = 1;
		view = function() { // ClassicPress: defer loading via require()
	...
	function requireFrame () {
		...
		hasRequiredFrame = 1;
		frame = function() { // ClassicPress: defer loading via require()
	...
	var mediaFrame;
	var hasRequiredMediaFrame;

	function requireMediaFrame () {
		if (hasRequiredMediaFrame) return mediaFrame;
		hasRequiredMediaFrame = 1;
		mediaFrame = function() { // ClassicPress: defer loading via require()
	...
	function requireSelect$1 () {
		...
		select$1 = function() { // ClassicPress: defer loading via require()
	...
	function requirePost () {
		...
		hasRequiredPost = 1;
		post = function() { // ClassicPress: defer loading via require()
	...
	var imageDetails$1;
	var hasRequiredImageDetails$1;

	function requireImageDetails$1 () {
		if (hasRequiredImageDetails$1) return imageDetails$1;
		hasRequiredImageDetails$1 = 1;
		imageDetails$1 = function() { // ClassicPress: defer loading via require()
	...
	function requireModal () {
		...
		hasRequiredModal = 1;
		modal = function() { // ClassicPress: defer loading via require()
	...
	function requireFocusManager () {
		...
		focusManager = function() { // ClassicPress: defer loading via require()
	...
	function requireWindow () {
		...
		hasRequiredWindow = 1;
		window$1 = function() { // ClassicPress: defer loading via require()
	...
	function requireEditor () {
		...
		hasRequiredEditor = 1;
		editor = function() { // ClassicPress: defer loading via require()
	...
	function requireInline () {
		...
		hasRequiredInline = 1;
		inline = function() { // ClassicPress: defer loading via require()
	...
	function requireStatus () {
		...
		hasRequiredStatus = 1;
		status = function() { // ClassicPress: defer loading via require()
	...
	var statusError;
	var hasRequiredStatusError;

	function requireStatusError () {
		if (hasRequiredStatusError) return statusError;
		hasRequiredStatusError = 1;
		statusError = function() { // ClassicPress: defer loading via require()
	...
	function requireToolbar () {
		...
		toolbar = function() { // ClassicPress: defer loading via require()
	...
	function requireSelect () {
		...
		hasRequiredSelect = 1;
		select = function() { // ClassicPress: defer loading via require()
	...
	var embed$1;
	var hasRequiredEmbed$1;

	function requireEmbed$1 () {
		if (hasRequiredEmbed$1) return embed$1;
		hasRequiredEmbed$1 = 1;
		embed$1 = function() { // ClassicPress: defer loading via require()
	...
	function requireButton () {
		...
		hasRequiredButton = 1;
		button = function() { // ClassicPress: defer loading via require()
	...
	function requireButtonGroup () {
		...
		buttonGroup = function() { // ClassicPress: defer loading via require()
	...
	var priorityList;
	var hasRequiredPriorityList;

	function requirePriorityList () {
		if (hasRequiredPriorityList) return priorityList;
		hasRequiredPriorityList = 1;
		priorityList = function() { // ClassicPress: defer loading via require()
	...
	function requireMenuItem () {
		...
		menuItem = function() { // ClassicPress: defer loading via require()
	...
	function requireMenu () {
		...
		hasRequiredMenu = 1;
		menu = function() { // ClassicPress: defer loading via require()
	...
	var routerItem;
	var hasRequiredRouterItem;

	function requireRouterItem () {
		if (hasRequiredRouterItem) return routerItem;
		hasRequiredRouterItem = 1;
		routerItem = function() { // ClassicPress: defer loading via require()
	...
	function requireRouter () {
		...
		hasRequiredRouter = 1;
		router = function() { // ClassicPress: defer loading via require()
	...
	function requireSidebar () {
		...
		sidebar = function() { // ClassicPress: defer loading via require()
	...
	function requireAttachment () {
		...
		attachment = function() { // ClassicPress: defer loading via require()
	...
	function requireLibrary () {
		...
		library = function() { // ClassicPress: defer loading via require()
	...
	var editLibrary;
	var hasRequiredEditLibrary;

	function requireEditLibrary () {
		if (hasRequiredEditLibrary) return editLibrary;
		hasRequiredEditLibrary = 1;
		editLibrary = function() { // ClassicPress: defer loading via require()
	...
	function requireAttachments () {
		...
		attachments = function() { // ClassicPress: defer loading via require()
	...
	function requireSearch () {
		...
		hasRequiredSearch = 1;
		search = function() { // ClassicPress: defer loading via require()
	...
	var hasRequiredAttachmentFilters;

	function requireAttachmentFilters () {
		if (hasRequiredAttachmentFilters) return attachmentFilters;
		hasRequiredAttachmentFilters = 1;
		attachmentFilters = function() { // ClassicPress: defer loading via require()
	...
	function requireDate () {
		...
		hasRequiredDate = 1;
		date = function() { // ClassicPress: defer loading via require()
	...
	var uploaded;
	var hasRequiredUploaded;

	function requireUploaded () {
		if (hasRequiredUploaded) return uploaded;
		hasRequiredUploaded = 1;
		uploaded = function() { // ClassicPress: defer loading via require()
	...
	function requireAll () {
		...
		hasRequiredAll = 1;
		all = function() { // ClassicPress: defer loading via require()
	...
	function requireBrowser () {
		...
		browser = function() { // ClassicPress: defer loading via require()
	...
	var selection$2;
	var hasRequiredSelection$2;

	function requireSelection$2 () {
		if (hasRequiredSelection$2) return selection$2;
		hasRequiredSelection$2 = 1;
		selection$2 = function() { // ClassicPress: defer loading via require()
	...
	var selection$1;
	var hasRequiredSelection$1;

	function requireSelection$1 () {
		if (hasRequiredSelection$1) return selection$1;
		hasRequiredSelection$1 = 1;
		selection$1 = function() { // ClassicPress: defer loading via require()
	...
	function requireSelection () {
		...
		selection = function() { // ClassicPress: defer loading via require()
	...
	var editSelection;
	var hasRequiredEditSelection;

	function requireEditSelection () {
		if (hasRequiredEditSelection) return editSelection;
		hasRequiredEditSelection = 1;
		editSelection = function() { // ClassicPress: defer loading via require()
	...
	function requireSettings () {
		...
		settings = function() { // ClassicPress: defer loading via require()
	...
	var attachmentDisplay;
	var hasRequiredAttachmentDisplay;

	function requireAttachmentDisplay () {
		if (hasRequiredAttachmentDisplay) return attachmentDisplay;
		hasRequiredAttachmentDisplay = 1;
		attachmentDisplay = function() { // ClassicPress: defer loading via require()
	...
	var gallery;
	var hasRequiredGallery;

	function requireGallery () {
		if (hasRequiredGallery) return gallery;
		hasRequiredGallery = 1;
		gallery = function() { // ClassicPress: defer loading via require()
	...
	var playlist;
	var hasRequiredPlaylist;

	function requirePlaylist () {
		if (hasRequiredPlaylist) return playlist;
		hasRequiredPlaylist = 1;
		playlist = function() { // ClassicPress: defer loading via require()
	...
	var details;
	var hasRequiredDetails;

	function requireDetails () {
		if (hasRequiredDetails) return details;
		hasRequiredDetails = 1;
		details = function() { // ClassicPress: defer loading via require()
	...
	var hasRequiredAttachmentCompat;

	function requireAttachmentCompat () {
		if (hasRequiredAttachmentCompat) return attachmentCompat;
		hasRequiredAttachmentCompat = 1;
		attachmentCompat = function() { // ClassicPress: defer loading via require()
	...
	function requireIframe () {
		...
		hasRequiredIframe = 1;
		iframe = function() { // ClassicPress: defer loading via require()
	...
	function requireEmbed () {
		...
		hasRequiredEmbed = 1;
		embed = function() { // ClassicPress: defer loading via require()
	...
	function requireLabel () {
		...
		hasRequiredLabel = 1;
		label = function() { // ClassicPress: defer loading via require()
	...
	function requireUrl () {
		...
		hasRequiredUrl = 1;
		url = function() { // ClassicPress: defer loading via require()
	...
	function requireLink () {
		...
		hasRequiredLink = 1;
		link = function() { // ClassicPress: defer loading via require()
	...
	function requireImage () {
		...
		hasRequiredImage = 1;
		image = function() { // ClassicPress: defer loading via require()
	...
	var imageDetails;
	var hasRequiredImageDetails;

	function requireImageDetails () {
		if (hasRequiredImageDetails) return imageDetails;
		hasRequiredImageDetails = 1;
		imageDetails = function() { // ClassicPress: defer loading via require()
	...
	function requireCropper () {
		if (hasRequiredCropper) return cropper;
		hasRequiredCropper = 1;
		cropper = function() { // ClassicPress: defer loading via require()
	...
	var siteIconCropper;
	var hasRequiredSiteIconCropper;

	function requireSiteIconCropper () {
		if (hasRequiredSiteIconCropper) return siteIconCropper;
		hasRequiredSiteIconCropper = 1;
		siteIconCropper = function() { // ClassicPress: defer loading via require()
	...
	var siteIconPreview;
	var hasRequiredSiteIconPreview;

	function requireSiteIconPreview () {
		if (hasRequiredSiteIconPreview) return siteIconPreview;
		hasRequiredSiteIconPreview = 1;
		siteIconPreview = function() { // ClassicPress: defer loading via require()
	...
	var editImage;
	var hasRequiredEditImage;

	function requireEditImage () {
		if (hasRequiredEditImage) return editImage;
		hasRequiredEditImage = 1;
		editImage = function() { // ClassicPress: defer loading via require()
	...
	function requireSpinner () {
		...
		spinner = function() { // ClassicPress: defer loading via require()
	...
	function requireHeading () {
		...
		heading = function() { // ClassicPress: defer loading via require()
	...
	var hasRequiredViews_manifest;

	function requireViews_manifest () {
		if (hasRequiredViews_manifest) return views_manifest;
		hasRequiredViews_manifest = 1;
		var media = wp.media,
			$ = jQuery,
			l10n;
		...
		media.controller.Region = requireRegion()();
		media.controller.StateMachine = requireStateMachine()();
		media.controller.State = requireState()();

		media.selectionSync = requireSelectionSync()();
		media.controller.Library = requireLibrary$1()();
		media.controller.ImageDetails = requireImageDetails$2()();
		media.controller.GalleryEdit = requireGalleryEdit()();
		media.controller.GalleryAdd = requireGalleryAdd()();
		media.controller.CollectionEdit = requireCollectionEdit()();
		media.controller.CollectionAdd = requireCollectionAdd()();
		media.controller.FeaturedImage = requireFeaturedImage()();
		media.controller.ReplaceImage = requireReplaceImage()();
		media.controller.EditImage = requireEditImage$1()();
		media.controller.MediaLibrary = requireMediaLibrary()();
		media.controller.Embed = requireEmbed$2()();
		media.controller.Cropper = requireCropper$1()();
		media.controller.CustomizeImageCropper = requireCustomizeImageCropper()();
		media.controller.SiteIconCropper = requireSiteIconCropper$1()();

		media.View = requireView()();
		media.view.Frame = requireFrame()();
		media.view.MediaFrame = requireMediaFrame()();
		media.view.MediaFrame.Select = requireSelect$1()();
		media.view.MediaFrame.Post = requirePost()();
		media.view.MediaFrame.ImageDetails = requireImageDetails$1()();
		media.view.Modal = requireModal()();
		media.view.FocusManager = requireFocusManager()();
		media.view.UploaderWindow = requireWindow()();
		media.view.EditorUploader = requireEditor()();
		media.view.UploaderInline = requireInline()();
		media.view.UploaderStatus = requireStatus()();
		media.view.UploaderStatusError = requireStatusError()();
		media.view.Toolbar = requireToolbar()();
		media.view.Toolbar.Select = requireSelect()();
		media.view.Toolbar.Embed = requireEmbed$1()();
		media.view.Button = requireButton()();
		media.view.ButtonGroup = requireButtonGroup()();
		media.view.PriorityList = requirePriorityList()();
		media.view.MenuItem = requireMenuItem()();
		media.view.Menu = requireMenu()();
		media.view.RouterItem = requireRouterItem()();
		media.view.Router = requireRouter()();
		media.view.Sidebar = requireSidebar()();
		media.view.Attachment = requireAttachment()();
		media.view.Attachment.Library = requireLibrary()();
		media.view.Attachment.EditLibrary = requireEditLibrary()();
		media.view.Attachments = requireAttachments()();
		media.view.Search = requireSearch()();
		media.view.AttachmentFilters = requireAttachmentFilters()();
		media.view.DateFilter = requireDate()();
		media.view.AttachmentFilters.Uploaded = requireUploaded()();
		media.view.AttachmentFilters.All = requireAll()();
		media.view.AttachmentsBrowser = requireBrowser()();
		media.view.Selection = requireSelection$2()();
		media.view.Attachment.Selection = requireSelection$1()();
		media.view.Attachments.Selection = requireSelection()();
		media.view.Attachment.EditSelection = requireEditSelection()();
		media.view.Settings = requireSettings()();
		media.view.Settings.AttachmentDisplay = requireAttachmentDisplay()();
		media.view.Settings.Gallery = requireGallery()();
		media.view.Settings.Playlist = requirePlaylist()();
		media.view.Attachment.Details = requireDetails()();
		media.view.AttachmentCompat = requireAttachmentCompat()();
		media.view.Iframe = requireIframe()();
		media.view.Embed = requireEmbed()();
		media.view.Label = requireLabel()();
		media.view.EmbedUrl = requireUrl()();
		media.view.EmbedLink = requireLink()();
		media.view.EmbedImage = requireImage()();
		media.view.ImageDetails = requireImageDetails()();
		media.view.Cropper = requireCropper()();
		media.view.SiteIconCropper = requireSiteIconCropper()();
		media.view.SiteIconPreview = requireSiteIconPreview()();
		media.view.EditImage = requireEditImage()();
		media.view.Spinner = requireSpinner()();
		media.view.Heading = requireHeading()();
		return views_manifest;
	}

	requireViews_manifest();
