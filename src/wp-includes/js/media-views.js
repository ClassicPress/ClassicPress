...
AttachmentsBrowser = View.extend(/** @lends wp.media.view.AttachmentsBrowser.prototype */{
	...
	initialize: function() {
		 ...
		 * This way, in the Media Library, it's right after the Add New button, see ticket https://core.trac.wordpress.org/ticket/37188.
		 */
		this.createUploader();
		...
		// For accessibility reasons, place the normal sidebar after the attachments, see ticket https://core.trac.wordpress.org/ticket/36909.
		if ( this.options.sidebar && 'errors' !== this.options.sidebar ) {
			this.createSidebar();
		}
