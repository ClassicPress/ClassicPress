 ...
 * Note: By default, the size of your logo should be no bigger than 80 x 80 pixels 
 * (though even this can change with custom CSS). 
 * Also change the link of the <a> link from the blog-url and title attribute from blog description
 */
