...
final class _WP_Editors {
	 ...
	 *     @type bool       $dfw               Since WP-4.3 used only to enqueue wp-fullscreen-stub.js
	 *                                         for backward compatibility. Used by the filter `quicktags_settings`, must be set to enable fullscreen mode.
