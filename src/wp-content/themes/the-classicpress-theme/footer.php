		...
		<div class="footerleft">
			...
			<div class="registration">
				...
				<ul class="social-menu">
					<li><a href="<?php echo esc_url( home_url() ); ?>" target="_blank" title="<?php esc_attr_e('Forums', 'classicpress'); ?>" rel="noreferrer noopener"><i class="cpicon-discourse"></i><span class="screen-reader-text"><?php _e('Support forums', 'classicpress'); ?></span></a></li>
					<li><a href="<?php echo esc_url( home_url( '/join-slack/' ) ); ?>" target="_blank" title="<?php esc_attr_e('Slack', 'classicpress'); ?>" rel="noreferrer noopener"><i class="cpicon-zulip"></i><span class="screen-reader-text"><?php _e('Join on Zulip Chat', 'classicpress'); ?></span></a></li>
					...
					<li><a href="<?php echo esc_url( 'https://fosstodon.org/@classicpress' ); ?>" target="_blank" title="<?php esc_attr_e('Mastodon', 'classicpress'); ?>" rel="noreferrer noopener"><i class="cpicon-mastodon"></i><span class="screen-reader-text"><?php _e( 'Follow on Mastodon', 'classicpress' ); ?></span></a></li>
