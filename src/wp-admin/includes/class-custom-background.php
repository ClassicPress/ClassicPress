...
<td><fieldset><legend class="screen-reader-text"><span>
		...
		?>
<input type="text" class="color-picker-hex" name="background-color" id="background-color" maxlength="7" data-coloris placeholder="#<?php echo esc_attr( get_background_color() ); ?>" value="#<?php echo esc_attr( get_background_color() ); ?>" <?php echo $default_color; ?>>
</fieldset></td>
</tr>
</tbody>
</table>
