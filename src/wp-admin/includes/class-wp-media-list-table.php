						...
						<div class="inline-edit-col">
							...
							<fieldset class="inline-edit-date">
								...
								<div class="timestamp-wrap">
									...
									<input id="quick-day" type="text" name="jj" value="" size="2" maxlength="2" inputmode="numeric" pattern="^([1-9]|0[1-9]|[12][0-9]|3[01])$" autocomplete="off" class="form-required">&nbsp;,
									<label for="quick-year">
										<span class="screen-reader-text"><?php echo esc_html_e( 'Year' ); ?></span>
									</label>
									<input id="quick-year" type="text" name="aa" value="" size="4" maxlength="4" inputmode="numeric" pattern="^([1-9][0-9][0-9][0-9])$" autocomplete="off" class="form-required">
								</div>
