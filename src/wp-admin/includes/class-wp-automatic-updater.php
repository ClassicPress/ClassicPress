...
class WP_Automatic_Updater {
	...
	public function should_update( $type, $item, $context ) {
		 ...
		 *
		 * Since ClassicPress 3.7, minor and development versions of core, and translations have
		 * been auto-updated by default. New installs on ClassicPress 5.6 or higher will also
	...
	public function update( $type, $item ) {
		...
		switch ( $type ) {
			...
			case 'translation':
				...
				/* translators: %s: Project name (plugin, theme, or ClassicPress). */
