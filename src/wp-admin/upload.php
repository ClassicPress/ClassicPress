...
$js_required_message = __( 'Media Library requires JavaScript to open media details in a dialog.' );
...
if ( 'grid' === $mode ) {
	...
	wp_admin_notice(
		__( 'You might need to refresh the page to see the uploaded files.' ),
		array(
			'id'                 => 'refresh',
