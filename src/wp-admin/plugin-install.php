	...
	array(
		...
		'content' =>
				'<p>' . sprintf(
					...
					__( 'Plugins hook into ClassicPress to extend its functionality with custom features. Plugins are developed independently from the core ClassicPress application by developers all over the world. All plugins in the <a href="%s">ClassicPress Plugin Directory</a> are compatible with the license ClassicPress uses.' ),
