...
<tr>
<th scope="row"><?php _e( 'Enable media attachment pages' ); ?></th>
...
<p class="description"><?php _e( 'An attachment page displays information about a particular media file you have uploaded to your site.' ); ?></p>
</td>
</tr>
