...
<div class="about-wrap-content">
	...
	<ol>
		<li><p><?php _e( 'You have the freedom to run the program, for any purpose (freedom 0).' ); ?></p></li>
		<li><p><?php _e( 'You have access to the source code, the freedom to study how the program works, and the freedom to change it to make it do what you wish (freedom 1).' ); ?></p></li>
		<li><p><?php _e( 'You have the freedom to redistribute copies of the original program so you can help your neighbor (freedom 2)' ); ?></p></li>
		<li><p><?php _e( 'You have the freedom to distribute copies of your modified versions to others. By doing this you can give the whole community a chance to benefit from your changes (freedom 3)' ); ?></p></li>
	</ol>
