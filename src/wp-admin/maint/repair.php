...
if ( ! defined( 'WP_ALLOW_REPAIR' ) ) {
	...
	if ( $problems ) {
		printf( '<p>' . __('Some database problems could not be repaired. Please copy-and-paste the following list of errors into the <a href="%s">support forum</a> for additional assistance.') . '</p>', __( 'https://forums.classicpress.net/c/supportc/support/' ) );
		$problem_output = '';
