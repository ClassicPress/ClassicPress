...
$help = '<p>' . __( 'Welcome to your WordPress Dashboard! This is the screen you will see when you log in to your site, and gives you access to all the site management features of ClassicPress. You can get help for any screen by clicking the Help tab above the screen title.' ) . '</p>';
...
if ( ! is_multisite() && current_user_can( 'install_plugins' ) )
	$help .= '<p>' . sprintf(
		...
		__( '<strong>ClassicPress News</strong> &mdash; Latest news from the official WordPress project, the <a href="%s">ClassicPress Planet</a>, and popular plugins.' ),
		__( 'https://planet.wordpress.org/' )
	) . '</p>';
else
	$help .= '<p>' . sprintf(
		/* translators: %s: WordPress Planet URL */
		__( '<strong>ClassicPress News</strong> &mdash; Latest news from the official WordPress project and the <a href="%s">ClassicPress Planet</a>.' ),
		__( 'https://planet.wordpress.org/' )
	) . '</p>';
