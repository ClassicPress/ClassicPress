...
ClassicPress version 2.0.0 is a fork of WordPress 6.2.x (without the block editor and everything related). Since then, a number of changes have been made to WordPress for performance, bugfixes or new features.
